...
class CustomUserCreationFormTest(TestCase):
    def test_valid_form(self):
        form_data = {"email": "form@example.com", "password1": "StrongPass123!", "password2": "StrongPass123!"}
        form = CustomUserCreationForm(data=form_data)
        self.assertTrue(form.is_valid())

    def test_invalid_form_email_required(self):
        form_data = {"email": "", "password1": "StrongPass123!", "password2": "StrongPass123!"}
        form = CustomUserCreationForm(data=form_data)
...
class RegisterViewTest(TestCase):
    def test_register_view_post(self):
        data = {"email": "newuser@example.com", "password1": "Testpass123", "password2": "Testpass123"}
